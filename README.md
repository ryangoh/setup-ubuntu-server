# Bash setup script for Ubuntu servers 24.04
...
```bash
cd ~
git clone https://github.com/ryangoh/setup-ubuntu-server.git
```
...
# Supported versions
This setup script has been tested against Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04 and Ubuntu 24.04.
